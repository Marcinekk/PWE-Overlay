    ...
    <div class="widget-panel w-full px-4 py-3">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-2">
                ...
                <span class="text-xs text-slate-400 uppercase tracking-wider font-mono">Czas</span>
            </div>
        </div>

        <div class="flex items-center justify-between mt-0.5">
            <div>
                <div class="text-xs text-slate-500 font-mono">Czas gry</div>
            ...
            <div class="text-right">
                <div class="text-xs text-slate-500 font-mono">Lokalny</div>
